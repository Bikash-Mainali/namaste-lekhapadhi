...
export function Janakari() {
    ...
    return (
        <section id="jankari" className="bg-gray-50 py-20 sm:py-22 md:py-30 dark:bg-gray-950">
            ...
            <div className="mx-auto flex w-full max-w-3/4 flex-col space-y-8 px-6">
                <section className="w-full text-left">
                    ...
                    <p className="text-gray-700 dark:text-gray-200">
                        ...
                        प्रयोग गरी सटीक नक्सा तयार गरिन्छ जसले जग्गाको वास्तविक स्थिति देखाउँछ।
                    </p>
                </section>
                ...
                <section className="w-full text-left">
                    ...
                    <p className="leading-relaxed text-gray-700 dark:text-gray-200">
                        ...
                        महत्वपूर्ण भूमिका खेलेको हुन्छ। सही नापी बिना कुनै जग्गा खरिद-बिक्री गर्दा समस्या आउन सक्छ।
                    </p>
                </section>
            ...
            <div className="mx-auto mt-20 flex w-full max-w-3/4 flex-col space-y-8 px-6">
                <section className="w-full text-left">
                    <img
                        src={JaggaNap}
                        alt="jagga nap sambandhi jankari"
                        className="h-auto w-auto sm:h-[500px] sm:w-[900px]"
                    />
                </section>
            </div>
